...
# ASN.1 source file:///usr/share/snmp/mibs/UPS-MIB.mib
# Produced by pysmi-0.3.4 at Sun Apr  7 19:35:31 2024
# On host ezzat-IdeaPad-3-15IIL05 platform Linux version 6.5.0-26-generic by user ezzat
...
ModuleIdentity, Unsigned32, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, NotificationType, TimeTicks, Counter64, IpAddress, Gauge32, Bits, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "Gauge32", "Bits", "Counter32", "MibIdentifier")
...
upsTrapAlarmEntryRemoved = NotificationType((1, 3, 6, 1, 6, 3, 1, 1, 5, 1)).setObjects(("UPS-MIB", "upsAlarmId"), ("UPS-MIB", "upsAlarmDescr"))
...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsMIB=upsMIB, upsOutputSource=upsOutputSource, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassEntry=upsBypassEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsFullCompliance=upsFullCompliance, upsInputEntry=upsInputEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentManufacturer=upsIdentManufacturer, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputNumLines=upsOutputNumLines, upsOutputPower=upsOutputPower, upsAlarmsPresent=upsAlarmsPresent, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConformance=upsConformance, upsTestResultsDetail=upsTestResultsDetail, upsInputLineBads=upsInputLineBads, upsOutputTable=upsOutputTable, upsBypassLineIndex=upsBypassLineIndex, upsBasicBypassGroup=upsBasicBypassGroup, upsInput=upsInput, upsOutputEntry=upsOutputEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapTestCompleted=upsTrapTestCompleted, PositiveInteger=PositiveInteger, upsInputTruePower=upsInputTruePower, upsAlarmTempBad=upsAlarmTempBad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputFrequency=upsOutputFrequency, upsIdentModel=upsIdentModel, upsAlarmDescr=upsAlarmDescr, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputNumLines=upsInputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsInputLineIndex=upsInputLineIndex, upsIdentName=upsIdentName, upsFullInputGroup=upsFullInputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBatteryTemperature=upsBatteryTemperature, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsGroups=upsGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicTestGroup=upsBasicTestGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetGroups=upsSubsetGroups, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsCompliances=upsCompliances, upsInputTable=upsInputTable, PYSNMP_MODULE_ID=upsMIB, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTest=upsTest, upsAlarmLowBattery=upsAlarmLowBattery, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBatteryStatus=upsBatteryStatus, upsAlarmFanFailure=upsAlarmFanFailure, upsTraps=upsTraps, upsTrapOnBattery=upsTrapOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsAlarm=upsAlarm, upsOutput=upsOutput, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfig=upsConfig, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestId=upsTestId, upsTestStartTime=upsTestStartTime, upsConfigOutputFreq=upsConfigOutputFreq, upsFullOutputGroup=upsFullOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassCurrent=upsBypassCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsInputCurrent=upsInputCurrent, upsBypassFrequency=upsBypassFrequency, upsFullIdentGroup=upsFullIdentGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsShutdownType=upsShutdownType, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassTable=upsBypassTable, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullTestGroup=upsFullTestGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputVoltage=upsOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsIdent=upsIdent, upsBattery=upsBattery, upsObjects=upsObjects, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAutoRestart=upsAutoRestart, upsTestSpinLock=upsTestSpinLock, upsInputVoltage=upsInputVoltage, upsBypassVoltage=upsBypassVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmInputBad=upsAlarmInputBad, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmId=upsAlarmId, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTable=upsAlarmTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmTime=upsAlarmTime, upsOutputPercentLoad=upsOutputPercentLoad, upsControl=upsControl, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputPower=upsConfigOutputPower, upsFullConfigGroup=upsFullConfigGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmEntry=upsAlarmEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputCurrent=upsOutputCurrent, upsBypassPower=upsBypassPower, upsBatteryCurrent=upsBatteryCurrent, upsBatteryVoltage=upsBatteryVoltage, upsBypassNumLines=upsBypassNumLines, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypass=upsBypass, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputFrequency=upsInputFrequency, upsFullControlGroup=upsFullControlGroup, upsBasicInputGroup=upsBasicInputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicGroups=upsBasicGroups, upsTestElapsedTime=upsTestElapsedTime, upsFullGroups=upsFullGroups, upsAlarmDepletedBattery=upsAlarmDepletedBattery)
